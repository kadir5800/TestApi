...
{
    public class MaterialDataAccess : MongoRepositoryBase<Material>, IMaterialDataAccess
    {
        private readonly MongoDbContext _context;
        private readonly IMongoCollection<Token> _collection;
        public MaterialDataAccess(IOptions<MongoSettings> settings) : base(settings)
        {
