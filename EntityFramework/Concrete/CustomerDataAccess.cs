...
{
    public class CustomerDataAccess : MongoRepositoryBase<Customer>, ICustomerDataAccess
    {
        private readonly MongoDbContext _context;
        private readonly IMongoCollection<Token> _collection;
        public CustomerDataAccess(IOptions<MongoSettings> settings) : base(settings)
        {
